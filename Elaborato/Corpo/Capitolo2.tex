...
\chapter{Note di teoria dei grafi}\label{secTeoriaGrafi}
    ...
    \section{Definizioni miscellanee}\label{secDefinizioniGrafi}
        ...
        \tikzexternalizedfigure{H}
            {../../Figure/.fnl/Capitolo2/EsempioGrafo[In]Diretto.tex}
    ...
    \section{Cenni sui dati}\label{secCenniSuiDati}
        ...
        \tikzexternalizedfigure{H}
            ...
            {Forza contro il grado per la Sardegna.}
        ...
        \tikzexternalizedfigure{p}[-1em]
            ...
            {Riproduzione dei principali grafici di \protect\cite{DeMontis2007} [a cui si rimanda per maggiori dettagli sui vari coefficienti] relativi alla topologia della rete del pendolarismo sarda.}
