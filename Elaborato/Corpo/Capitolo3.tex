    ...
    \section{Descrizione cinetica urbana su reti}\label{secDescrizioneCineticaUrbana} %  d'interazioni mediante da un grafo
            ...
            \subsubsection{Descrizione e derivazione}
                ...
                \begin{oss}
                    ...
                    \[
                        ...
                        \end{aligned}\right.
                    \]
                    che soddisfà la staticità di \(I\) e \(I_*\) e completa, assieme a \ref{eqAlgoritmoInterazioneUrbano}, la formulazione dell'\ref{eqAlgoritmoInterazione} piú generale.
                \end{oss}
        ...
        \subsection{Equazione di tipo Boltzmann approssimata}\label{secApprossimazione}
            ...
            \tikzexternalizedfigure{tb}%h
                ...
                {Rappresentazione grafica del \cref{teoRilassamentoTopologia}.}
                {.8\linewidth}{figRappresentazioneGraficaApprossimazione}
