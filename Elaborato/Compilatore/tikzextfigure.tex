    ...
    \begin{figure}[#2]%
        ...
        \IfSubStr{#2}{p}{% 
            ...
            \makebox[0pt][l]{%
                ...
                \def\hsep{-0.4cm}\Ifthispageodd{\def\offset{+\hsep}}{\def\offset{-\hsep}}% per far toccare il bordo sinistro/destro dei grafici al margine interno/esterno si trasla di -/+1.9 cm
