...
\chapter{Note di teoria dei grafi}\label{secTeoriaGrafi}
    ...
    \section{Cenni sui dati}\label{secCenniSuiDati}
        ...
        Sono stati anche riprodotti i risultati di \cite{DeMontis2007}, ma l'unico importante da mostrare è quello relativo alla correlazione positiva tra la forza e il grado del nodo nella Fig. \daRivedere{}, mentre tutti gli altri sono elencati per completezza nella Fig. \daRivedere{}.