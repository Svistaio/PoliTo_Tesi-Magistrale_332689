...
\chapter{Simulazioni}\label{secSimulazioni}
    ...
    \section{Rappresentazione dei risultati}
        ...
        \subsection{Struttura dei dati}
            ...
            \begin{ipo}
                In questa trattazione si considerano \(N_f=50\), \(N_s=1000\) mentre \(N_t\) viene scelto per essere poco superiore al tempo di convergenza della simulazione, se i risultati convergono, ma sicuramente è un multiplo di \(10\) per garantire che \(N_s\) sia un suo divisore.
            \end{ipo}
    ...
    \section{Regole d'emigrazione}
        ...
        Infine si avvisa che per tutte le regioni italiane, Italia inclusa, sono stati ottenuti analoghi risultati a quelli venturi della Sardegna; questa è la ragione per cui in questo paragrafo ci si concentrerà solo su quella regione, sebbene alcuni sono analizzati anche per l'Italia alla fine.
        ...
        \subsection{Il caso dell'Italia}
