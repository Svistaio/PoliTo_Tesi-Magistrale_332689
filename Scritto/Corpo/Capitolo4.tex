        ...
        \subsection{Regola taglia}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{ccccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Dati e parametri della \ref{eqRegolaEmigrazioneTaglia}.}
        ...
        \subsection{Regola taglia-gradi}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{ccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Dati e parametri della \ref{eqRegolaEmigrazioneTagliaGradi}.}
                \label{tabParametriRegolaEmigrazioneTagliaGradi}
            \end{table}

            \tikzfigure{p}
            {\input{../../Figure/.fnl/Capitolo4/RETGConfigurazioneRiferimento/Infopagina.tex}}
            {Studio della configurazione di riferimento della \cref{eqRegolaEmigrazioneTagliaGradi} con parametri dalla \cref{tabParametriRegolaEmigrazioneTagliaGradi}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
        ...
        \subsection{Regola frazionata}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{cccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Dati e parametri della \ref{eqRegolaEmigrazioneTagliaGradiFrazionata}.}
            ...
            {Studio della configurazione di riferimento della \cref{eqRegolaEmigrazioneTagliaGradiFrazionata} con parametri dalla \cref{tabParametriRegolaEmigrazioneTagliaGradiFrazionata}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
        ...
        \subsection{Regola taglia-forza}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{ccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Dati e parametri della \ref{eqRegolaEmigrazioneTagliaForza}.}
