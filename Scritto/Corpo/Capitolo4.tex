        ...
        \subsection{Regola taglia}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{ccccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Parametri della \ref{eqRegolaEmigrazioneTaglia}.}
                \label{tabParametriRegolaEmigrazioneTaglia}
            \end{table}

            % \tikzfigure{p}
                % {\input{../../Figure/.fnl/Capitolo4/RETConfigurazioneRiferimento/Stabile/Infopagina.tex}}
            \tikzexternalizedfigure{p}
                {../../Figure/.fnl/Capitolo4/RETConfigurazioneRiferimento/Stabile/Infopagina.tex}
                ...
                {.6\linewidth}{figStudioConfigurazioneRiferimentoStabileRET}

            % \tikzfigure{p}
                % {\input{../../Figure/.fnl/Capitolo4/RETConfigurazioneRiferimento/Instabile/Infopagina.tex}}
            \tikzexternalizedfigure{p}
                {../../Figure/.fnl/Capitolo4/RETConfigurazioneRiferimento/Instabile/Infopagina.tex}
                ...
                {.6\linewidth}{figStudioConfigurazioneRiferimentoInstabileRET}

        \subsection{Regola taglia-gradi}

            \eqtag{\([\text{RE}]_{SK}\)}{
                \label{eqRegolaEmigrazioneTagliaGradi}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{ccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Parametri della \ref{eqRegolaEmigrazioneTagliaGradi}.}
                \label{tabParametriRegolaEmigrazioneTagliaGradi}
            \end{table}

            % \tikzfigure{p}
                % {\input{../../Figure/.fnl/Capitolo4/RETGConfigurazioneRiferimento/Infopagina.tex}}
            \tikzexternalizedfigure{p}
                {../../Figure/.fnl/Capitolo4/RETGConfigurazioneRiferimento/Infopagina.tex}
                {Studio della configurazione di riferimento della \ref{eqRegolaEmigrazioneTagliaGradi} con parametri dalla \cref{tabParametriRegolaEmigrazioneTagliaGradi}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                {.6\linewidth}{figStudioConfigurazioneRiferimentoInstabileRETG}

        \subsection{Regola frazionata}
            
            \eqtag{\([\text{RE}]^f_{SK}\)}{
                \label{eqRegolaEmigrazioneTagliaGradiFrazionata}
                E^f_{SK}(s,s_*,i,i_*)\equiv (1-\zeta)E_{SK}(s,s_*,k_i,k_{i_*})+\zeta E_{SK}(s_*,s,k_{i_*},k_i)
            }%
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{cccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Parametri della \ref{eqRegolaEmigrazioneTagliaGradiFrazionata}.}
                \label{tabParametriRegolaEmigrazioneTagliaGradiFrazionata}
            \end{table}

            % \tikzfigure{p}
                % {\input{../../Figure/.fnl/Capitolo4/RETGfConfigurazioneRiferimento/Infopagina.tex}}
            \tikzexternalizedfigure{p}
                {../../Figure/.fnl/Capitolo4/RETGfConfigurazioneRiferimento/Infopagina.tex}
                {Studio della configurazione di riferimento della \ref{eqRegolaEmigrazioneTagliaGradiFrazionata} con parametri dalla \cref{tabParametriRegolaEmigrazioneTagliaGradiFrazionata}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                {.6\linewidth}{figStudioConfigurazioneRiferimentoInstabileRETGf}
        ...
        \subsection{Regola taglia-forza}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{ccc}
                    ...
                    \hline
                \end{tabular}
                \caption{Parametri della \ref{eqRegolaEmigrazioneTagliaForza}.}
            ...
            \tikzexternalizedfigure{p}
                {../../Figure/.fnl/Capitolo4/RETFConfigurazioneRiferimento/Infopagina.tex}
                {Studio della configurazione di riferimento della \ref{eqRegolaEmigrazioneTagliaForza} con parametri dalla \cref{tabParametriRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{cccc}
                    \hline
                    \(\lambda\)&\(N_p\)&\(\alpha\)&\(N_t\)\\
                    \hline
                    \([\num{.01},\num{.3}]\)&5&\(\num{.44}\)&\(\num{3e6}\)\\
                    \hline
                \end{tabular}
                \caption{Parametri dello studio parametrico \(\lambda\).}
                \label{tabStudioParametricolRegolaEmigrazioneTagliaForza}
            \end{table}
            ...
            \begin{table}[htb]
                ...
                \begin{tabular}{cccc}
                    \hline
                    \(\lambda\)&\(\alpha\)&\(N_p\)&\(N_t\)\\
                    \hline
                    \(\num{.18}\)&\([\num{.3},\num{.6}]\)&5&\(\num{3e6}\)\\
                    \hline
                \end{tabular}
                \caption{Parametri dello studio parametrico \(\alpha\).}
                \label{tabStudioParametricoaRegolaEmigrazioneTagliaForza}
            \end{table}

            %\begingroup Inizio studio parametrico l
                % \tikzfigure{p}
                    % {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SDF1/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SDF1/Infopagina.tex}
                    {Distribuzioni dello studio parametrico \(\lambda\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricolRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricolRETFSDF1}

                % \tikzfigure{p}
                    % {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SDF2/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SDF2/Infopagina.tex}
                    {Adattamenti di Pareto dello studio parametrico \(\lambda\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricolRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricolRETFSDF2}

                % \tikzfigure{p}
                    % {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SDF3/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SDF3/Infopagina.tex}
                    {Adattamenti di Pareto e lognormali bimodali dello studio parametrico \(\lambda\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricolRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricolRETFSDF3}

                % \tikzfigure{p}
                    % {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SVsD/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SVsD/Infopagina.tex}
                    {Taglie contro gradi dello studio parametrico \(\lambda\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricolRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricolRETFSVsD}

                % \tikzfigure{p}
                    % {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SE/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricol/SE/Infopagina.tex}
                    {Evoluzioni delle taglie medie delle classi dei gradi dello studio parametrico \(\lambda\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricolRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricolRETFSE}
            %\endgroup

            %\begingroup Studio parametrico a
                % \tikzfigure{p}
                %     {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SDF1/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SDF1/Infopagina.tex}
                    {Distribuzioni dello studio parametrico \(\alpha\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricoaRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricoaRETFSDF1}
    
                % \tikzfigure{p}
                %     {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SDF2/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SDF2/Infopagina.tex}
                    {Adattamenti di Pareto dello studio parametrico \(\alpha\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricoaRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricoaRETFSDF2}
    
                % \tikzfigure{p}
                %     {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SDF3/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SDF3/Infopagina.tex}
                    {Adattamenti di Pareto e lognormali bimodali dello studio parametrico \(\alpha\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricoaRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricoaRETFSDF3}
    
                % \tikzfigure{p}
                %     {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SVsD/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SVsD/Infopagina.tex}
                    {Taglie contro gradi dello studio parametrico \(\alpha\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricoaRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricoaRETFSVsD}
                    
                % \tikzfigure{p}
                %     {\input{../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SE/Infopagina.tex}}
                \tikzexternalizedfigure{p}
                    {../../Figure/.fnl/Capitolo4/RETFStudioParametricoa/SE/Infopagina.tex}
                    {Evoluzioni delle taglie medie delle classi dei gradi dello studio parametrico \(\alpha\) con \ref{eqRegolaEmigrazioneTagliaForza} e parametri dalla \cref{tabStudioParametricoaRegolaEmigrazioneTagliaForza}; per la spiegazione dei grafici si veda il \cref{secDefinizioneGrafici}.}
                    {.7\linewidth}{figStudioParametricoaRETFSE}
            %\endgroup

        \subsection{Interpretazioni}

            In poche parole la \eqref{eqRegolaEmigrazioneTaglia} descrive la tendenza degl'individui di aggregarsi per i piú svariati motivi: lavoro, sicurezza, famiglia, eccetera.
