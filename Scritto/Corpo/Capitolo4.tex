...
\chapter{Simulazioni}\label{secSimulazioni}
    ...
    \section{Regole d'emigrazione}\label{secRegoleEmigrazione}
        ...
        La scelta di \(E\) dipende da come si vuole modellizzare il fenomeno dell'immigrazione. In tutte le regole a venire \(s\) e \(s_*\) vanno intese come rispettivamente la città interagente e ricevente
    ...
    \section{Altri casi notevoli}
        ...
        \subsection{Il caso della Valle d'Aosta}
