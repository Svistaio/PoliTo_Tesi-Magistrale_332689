...
%\begingroup Citazioni
    ...
    \crefrangeformat{figure}{Capp.~#3#1#4--#5#2#6}
    \crefmultiformat{figure}{Capp.~#2#1#3}{ e~#2#1#3}{, #2#1#3}{ e~#2#1#3}
    \crefrangemultiformat{figure}{Capp.~#3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}
    
    \crefname{section}{§}{§§}
    \crefrangeformat{figure}{§§~#3#1#4--#5#2#6}
    \crefmultiformat{figure}{§§~#2#1#3}{ e~#2#1#3}{, #2#1#3}{ e~#2#1#3}
    \crefrangemultiformat{figure}{§§~#3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}
    ...
    \crefrangeformat{figure}{Propp.~#3#1#4--#5#2#6}
    \crefmultiformat{figure}{Propp.~#2#1#3}{ e~#2#1#3}{, #2#1#3}{ e~#2#1#3}
    \crefrangemultiformat{figure}{Propp.~#3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}

    \crefname{dfn}{Def.}{Deff.}
    \crefrangeformat{figure}{Deff.~#3#1#4--#5#2#6}
    \crefmultiformat{figure}{Deff.~#2#1#3}{ e~#2#1#3}{, #2#1#3}{ e~#2#1#3}
    \crefrangemultiformat{figure}{Deff.~#3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}

    \crefname{oss}{Oss.}{Oss.ni}
    \crefrangeformat{figure}{Oss.ni~#3#1#4--#5#2#6}
    \crefmultiformat{figure}{Oss.ni~#2#1#3}{ e~#2#1#3}{, #2#1#3}{ e~#2#1#3}
    \crefrangemultiformat{figure}{Oss.ni~#3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}
    % https://www.treccani.it/magazine/lingua_italiana/domande_e_risposte/grammatica/grammatica_123.html

    \crefname{ipo}{Ip.}{Ipp.}
    \crefrangeformat{figure}{Ipp.~#3#1#4--#5#2#6}
    \crefmultiformat{figure}{Ipp.~#2#1#3}{ e~#2#1#3}{, #2#1#3}{ e~#2#1#3}
    \crefrangemultiformat{figure}{Ipp.~#3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ e~#3#1#4--#5#2#6}
%\endgroup
...
%\begingroup Matematica
    ...
    % \newtheorem{dfnn}{Definizioni}[chapter]
