...
%\begingroup TikZ
    ...
    %\begingroup TikZFigure
        ...
        \newcommand\tikzfigure@nostar[6][-1em]{%
            \begin{figure}[#2]%
                \centering%
    ...
    %\begingroup Impostazioni
        ...
        %\begingroup Gruppi
            \newcommand\rectoGroupOptions{\pgfplotsset{/pgfplots/group/yDescPos/.style={y descriptions at=edge right}}}
            \newcommand\versoGroupOptions{\pgfplotsset{/pgfplots/group/yDescPos/.style={y descriptions at=edge left}}}
            % \Ifthispageodd{%
