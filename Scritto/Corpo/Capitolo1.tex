...
\chapter{Introduzione}\label{secIntroduzione}
    ...
    \begin{equation}
        ...
        f_T(t)=\xi f^1_T(t)+(1-\xi)f^2_T(t),
    \end{equation}
    %
    ove \(\xi\in[0,1]\) è un parametro da fittare tanto quanto le medie e le varianze associate a \(f^1_T(t)\) e \(f^2_T(t)\) per un totale di 5 parametri.
