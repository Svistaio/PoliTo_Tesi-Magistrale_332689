        ...
        \subsection{Equazione di Boltzmann omogenea}
            ...
            \begin{ipo}
                ...
                \begin{enumerate}[
                    ...
                    \item\label{ipGasRarefatto} è rarefatto, da cui si può assumere che solo interazioni binarie possono aver luogo;
                    \item\label{ipGasParticelleIndistinguibili} è composto da particelle indistinguibili e aventi ugual massa;
                    \item\label{ipGasCollisioniElastiche} le collisioni sono elastiche per cui, unito alla \ref{ipGasRarefatto}, porta alla conservazione dell'impulso e dell'energia:
                    %
                    \begin{align}
                        v'+v_*'&=v+v_*,
                        \label{eqConservazioneImpulso}\tag{CI}\\
                        \vert v'\vert^2+\vert v_*'\vert^2&=
                        \vert v\vert^2+\vert v_*\vert^2,
                        \label{eqConservazioneEnergia}\tag{CE}
                    \end{align}
                    %
                    ove \(v',v'_*\in\mathbb R^3\) sono le velocità poscollisionali che collidono colle velocità precollisionali \(v,v_*\in\mathbb R^3\), delle due particelle interagenti\footnotemark{}.
            ...
            \end{ipo}
            %
            Dalla \ref{ipGasCollisioniElastiche} si possono in realtà caratterizzare pienamente le velocità poscollisionali.
            %
            \begin{prp}
                Esistono due funzioni \(\hat v,\hat v_*\colon\mathbb R^3\to\mathbb R^3\) che soddisfanno \cref{eqConservazioneImpulso,eqConservazioneEnergia} e tali che
                %
                \begin{equation}
                    \label{eqVelocitàPosCollisionali}
                    \begin{aligned}
                        v'&=\hat v(v,v_*)\equiv v+[(v_*-v)\cdot n]n,\\
                        v'_*&=\hat v_*(v,v_*)\equiv v_*+[(v-v_*)\cdot n]n,
                    \end{aligned}
                \end{equation}
                %
            ...
            \begin{proof}
                ...
                \begin{equation}
                    ...
                    v'=v-\gamma n\quad\text{ e }\quad v'_*=v_*+\gamma n,
                \end{equation}
                %
                ...
                \[
                    \begin{aligned}
                        \vert v'\vert^2+\vert v_*'\vert^2
                        &=\vert v-\gamma n\vert^2+\vert v_*+\gamma n\vert^2\\
                        &=(v-\gamma n)\cdot(v-\gamma n)+(v_*+\gamma n)\cdot(v_*+\gamma n)\\
                        &=\vert v\vert^2-2\gamma(v\cdot n)+\gamma^2+\vert v_*\vert^2+2\gamma(v_*\cdot n)+\gamma^2\\
                        &=\vert v\vert^2+\vert v_*\vert^2-2\gamma[(v_*-v)\cdot n+2\gamma]\\
                        &=\vert v\vert^2+\vert v_*\vert^2\ \ \implies\ \ \gamma[(v_*-v)\cdot n+\gamma]=0,
                    \end{aligned}
                \]
                ma escludendo il caso banale di \(\gamma=0\) (nessuna interazione) si ha
                \[
                    \gamma=\hat\gamma(v,v_*)\equiv(v-v_*)\cdot n,
                \]
                per cui \(\gamma\) è in realtà una funzione delle velocità precollisionali; la \eqref{eqAnsatzCollisioni} diventa allora
                %
                \begin{equation}
                    \label{eqVelocitàPoscollisionali}
                    v'=v+[(v_*-v)\cdot n]n\quad\text{ e }\quad v'_*=v_*+[(v-v_*)\cdot n]n.
                \end{equation}
            \end{proof}

            Si noti come la precedente dimostrazione lasci arbitrario \(n\in\mathbb S^2\), seppure da un punto di vista sia ragionevole porlo parallelo al vettore passante per i centri delle particelle collidenti.%; cosí è considerato da qui in poi.

            Per poter dedurre l'equazione di Boltzmann omogenea è però necessaria una descrizione statistica del precedente gas: sia \(V_t,V_t^*\in\mathbb R^3\) le variabili aleatorie\footnotemark{} delle velocità precollisionali, di cui le \(v\) e \(v_*\) precedenti sono due realizzazioni, al tempo \(t\) e similmente per \(V'_t,V^{*\prime}_t\in\mathbb R^3\).
            \footnotetext{Si noti come queste non dipendano dall'indice proprio per l'ipotesi \ref{ipGasParticelleIndistinguibili} d'indistinguibilità delle particelle.}

            Le leggi d'interazione nella \eqref{eqVelocitàPosCollisionali} diventano
            %
            \begin{equation}
            ...
            \end{equation}
            %
            in cui anche \(n\) risulta essere aleatoriamente distribuita; usualmente s'ipotizza \(n\sim\mathcal U(\mathbb S^2)\), vale a dire che non vi sono direzioni preferenziali essendo queste uniformemente distribuite sulla sfera unitaria.

            Invece per modellare la dinamica basata su interazioni binarie si fissa un passo temporale \(\Delta t>0\), si campionano indipendentemente due agenti e si presuppone che questi interagiscano con una certa probabilità, ovvero
            %
            \[
                \def\theequation{[AR]}
                ...
                [AR]\left\{
                \begin{aligned}
                    V_{t+\Delta t}&=(1-\Theta)V_t+\Theta V'_t,\\
                    V^*_{t+\Delta t}&=(1-\Theta)V^*_t+\Theta V^{*\prime}_t.
                \end{aligned}
                \right.
                \notag
            \]
            ...
            ove 
            \[
                \Theta\sim\DstrBernoulli(B((V^*_t-V_t)\cdot n)\Delta t)
            \] 
            è una variabile aleatoria, indipendente da \(V_t\) e \(V^*_t\), che indica se l'interazione avviene o no; essa dipende dalla funzione \(B\colon\mathbb R\to\mathbb R_+\), detta nucleo di collisione, che permette d'avere una maggiore espressività sulle collisioni molecolari le quali possono influenzare  il tasso d'interazione tra le molecole. Per definizione di \(\Theta\) deve valere \(B((V^*_t-V_t)\cdot n)\Delta t\le1\) condizione soddisfacibile anche prendendo un passo temporale \(\Delta t\) adattivo.

            Si noti come \(B\) dipenda da \((V_*-V)\cdot n\) cosa che permette d'interpretare \(n\) come la direzione lungo la quale le interazioni sono piú frequenti.
