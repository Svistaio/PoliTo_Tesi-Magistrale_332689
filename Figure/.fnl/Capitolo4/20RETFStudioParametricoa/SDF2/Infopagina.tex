...
\begin{tikzpicture}%
    ...
    %\begingroup Righe
        \begin{groupplot}[
            ...
            ymin=0.00024855,ymax=1,
        ]
            \nextgroupplot[%
                xmin=2.8042,xmax=6.0203,
                % xmin=3.6,xmax=4.8,
                % ymin=0.001,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig7.tex}
        ...
        \begin{groupplot}[
            ...
            %
            % xmin=3637.5,xmax=2.5003e+05,
            ymin=0.0021681,ymax=1,
        ]
            \nextgroupplot[%
                at={($(Row1 c1r1.south west)-(0,\yPlotSep em)-(0,\plotHeight cm)$)},
                xmin=2.8042,xmax=6.0203,
                % xmin=3.6,xmax=5.2,
                % ymin=0.0045249,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig16.tex}
            ...
            \nextgroupplot[%
                ...
                % xmin=3.4,xmax=5.4,
                % ymin=0.001,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig17.tex}
            ...
            \nextgroupplot[%
                ...
                % xmin=3.4,xmax=5.4,
                % ymin=0.001,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig18.tex}
        ...
        \begin{groupplot}[
            ...
            %
            % xmin=3637.5,xmax=2.5003e+05,
            ymin=0.0036913,ymax=1,
        ]
            \nextgroupplot[%
                at={($(Row2 c1r1.south west)-(0,\yPlotSep em)-(0,\plotHeight cm)$)},
                xmin=2.8042,xmax=6.0203,
                % xmin=3.5,xmax=5.5,
                % ymin=0.0050687,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig25.tex}
            ...
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig26.tex}
            ...
            \nextgroupplot[%
                ...
                % xmin=3.5,xmax=5.5,
                % ymin=0.001,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig27.tex}
        ...
        \begin{groupplot}[
            ...
            \nextgroupplot[%
                ...
                % xmin=2.5,xmax=6.5,
                % ymin=0.0053191,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig43.tex}
            ...
            \nextgroupplot[%
                xmin=2.8042,xmax=6.0203,
                % xmin=2.5,xmax=6.5,
                % ymin=0.00074127,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig44.tex}
            ...
            \nextgroupplot[%
                ...
                % xmin=2.5,xmax=6.5,
                % ymin=0.00075905,ymax=1,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricoa/SDF2/SDFfig45.tex}
