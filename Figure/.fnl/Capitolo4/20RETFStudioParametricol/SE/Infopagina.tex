...
\begin{tikzpicture}%
    %\begingroup Righe
        \begin{groupplot}[
            ...
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig1.tex}
            % \input{../../../../.tex/20/KS/SizeEvolutionsfig1.tex}

            \nextgroupplot[%
                % xmin=0,xmax=1e+05,
                % ymin=100,ymax=1.4472e+05,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig2.tex}
        ...
        \begin{groupplot}[
            ...
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig3.tex}
            ...
            \nextgroupplot[%
                % xmin=0,xmax=1e+05,
                % ymin=100,ymax=1.5103e+05,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig4.tex}
        ...
        \begin{groupplot}[
            ...
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig5.tex}
            ...
            \nextgroupplot[%
                % xmin=0,xmax=1e+05,
                % ymin=100,ymax=1.539e+05,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig6.tex}
        ...
        \begin{groupplot}[
            ...
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig7.tex}
            ...
            \nextgroupplot[%
                % xmin=0,xmax=1e+05,
                % ymin=100,ymax=1.5886e+05,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig8.tex}
        ...
        \begin{groupplot}[
            ...
            \nextgroupplot[%
                ...
                % xmin=0,xmax=1e+05,
                % ymin=100,ymax=1.6107e+05,
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig9.tex}
            ...
            ] \input{../../Figure/.fnl/Capitolo4/20RETFStudioParametricol/SE/SEfig10.tex}
