...
\begin{tikzpicture}%
    ...
    %\begingroup Righe
        ...
        \begin{groupplot}[
            ...
            xmin=0,xmax=30000,
            ymin=100,ymax=160451.197792539,
        ]
            \nextgroupplot[%
                at={($
                ...
                $)},
                % xmin=0,xmax=30000,
                % ymin=100,ymax=154171.220519023,
            ] \input{../../Figure/.fnl/Capitolo4/RETConfigurazioneRiferimento/SEfig1.tex}
            % \input{../../../.tex/20/KS/SizeEvolutionsfig1.tex}

            \nextgroupplot[%
                % xmin=0,xmax=30000,
                % ymin=100,ymax=160451.197792539,
            ] \input{../../Figure/.fnl/Capitolo4/RETConfigurazioneRiferimento/SEfig2.tex}
    ...
    %\begingroup Parametri
        ...
        \node[Parametri] at ([shift={(\xShift,\yShift)}]EA) {
            \(\begin{aligned}
                \textcolor{blueish}{\beta}&\textcolor{blueish}{=\betaAprx}\\[\yLineShift]
                \textcolor{reddish}{\beta}&\textcolor{reddish}{=\betaExact}
            \end{aligned}\)
        };
