...
\begin{tikzpicture}[
    ...
    %\begingroup Uguaglianze e approssimazioni
    ...
    %\begingroup Annotazioni
        \newcommand\hsepAnnotation{1em}
        \node (textK) [right=\hsepAnnotation of d,anchor=west,align=left] {\dimTesto{10pt} Topologia rilassata (\(\underhat k\))};
        \node (textB) [right=\hsepAnnotation of g,anchor=west,align=left] {\dimTesto{10pt} Topologia approssimata (\(\mathbf B\))};
        \node (textA) [right=\hsepAnnotation of f,anchor=west,align=left] {\dimTesto{10pt} Topologia esatta (\(\mathbf A\))};
    %\endgroup
    ...
    %\begingroup Rettangoli
        ...
        %     \draw [rectangleStyle,fill=red!75] (textK.north west |- textB.north west) rectangle (textK.south east |- textB.south east);
        %     \draw [rectangleStyle,fill=blue!75] (textK.north west |- textA.north west) rectangle (textK.south east |- textA.south east);
        % \end{scope}
    %\endgroup
\end{tikzpicture}
